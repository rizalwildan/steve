...
import de.rwth.idsg.steve.web.dto.TransactionForm;
...
public class TransactionsRestController {
    ...
    public ResponseEntity<String> startRemoteTransaction(@RequestBody @Valid TransactionForm params) {
        log.debug("Read request for params: {}", params);

        return new ResponseEntity<>(params.toString(), HttpStatus.CREATED);
    }
}
